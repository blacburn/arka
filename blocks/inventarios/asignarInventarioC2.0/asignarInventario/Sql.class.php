...
class Sql extends \Sql {
	...
	function getCadenaSql($tipo, $variable = "") {
		...
		switch ($tipo) {
			...
			case "consultarProvedor" :
				$cadenaSql = ' SELECT "PRO_IDENTIFICADOR", "PRO_NIT", "PRO_RAZON_SOCIAL", "PRO_DIRECCION", 
							       "PRO_TELEFONO"
							  FROM arka_parametros.arka_proveedor WHERE "PRO_IDENTIFICADOR"=\' '.$variable.' \' ;';
				
				
				break;
			
			case "consultarProvedoreqwes" :
				$cadenaSql = ' SELECT "PRO_IDENTIFICADOR"
							  FROM arka_parametros.arka_proveedor  ';
